// Hello.cs
// Vulkan 1.4 Triangle via Windows.UI.Composition (Win32 Desktop Interop)
...
";
    ...
    static unsafe void RenderVulkan(IntPtr context, IntPtr swapChain)
    {
        ...
        var cv = new VkClearVal { color = new VkClearCol { r = 0.0f, g = 0.0f, b = 0.0f, a = 1f } };
    ...
    static unsafe int Main(string[] args)
    {
        ...
        dbg(FN, "========================================");
        dbg(FN, "Vulkan 1.4 Triangle via Composition (C# vtable)");
        dbg(FN, "========================================");
        ...
        while (msg.message != WM_QUIT)
        {
            ...
            {
                RenderVulkan(context, swapChain);
            }
        }
