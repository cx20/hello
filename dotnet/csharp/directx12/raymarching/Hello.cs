...
public class Hello
{
    ...
    private void LoadAssets()
    {
        ...
        try
        {
            ...
            if (result < 0)
            {
                if (error != IntPtr.Zero)
                {
                    ...
                    Console.WriteLine($"Root signature serialization error: {errorMsg}");
                }
            ...
            Console.WriteLine($"Root signature created: {rootSignature:X}");
        }
        finally
        {
            cbvRangeHandle.Free();
        ...
        try
        {
            ...
            Console.WriteLine($"Pipeline state created: {pipelineState:X}");
        }
        finally
        {
        ...
        Console.WriteLine("[LoadAssets] - Complete");
    }
    ...
    private void LoadPipeline(IntPtr hwnd)
    {
        ...
        if (debugResult >= 0 && debugInterface != IntPtr.Zero)
        {
            ...
            Console.WriteLine("Debug layer enabled.");
        }
        ...
        Console.WriteLine("D3D12 Device created.");
        ...
        Console.WriteLine("Calling CreateSwapChainForHwnd...");
        ...
        Console.WriteLine("Swap Chain created.");
        ...
        Console.WriteLine("[LoadPipeline] - Complete");
    }
    ...
    {
        Console.WriteLine("Raymarching - DirectX 12 / C#");
        Console.WriteLine("========================================");
