...
var createOpenGLInvoker = (function() {
    var source = [
        ...
        "  // Delegates for OpenGL 4.6 functions",
...
// Global variables for OpenGL 4.6 function pointers
...
// Load OpenGL 4.6 extension functions
function LoadOpenGL3Extensions(): Boolean {
  DebugLog("Loading OpenGL 4.6 extensions...");
  ...
  try {
    ...
    DebugLog("OpenGL 4.6 extension functions found: " + functionsLoaded + "/19");
    return (functionsLoaded >= 5);

  } catch (e) {
    DebugLog("Exception loading OpenGL 4.6 extensions: " + e.Message);
    return false;
  }
}

// OpenGL 4.6 function wrappers using C# invoker
...
// OpenGL 4.6 context initialization using wglCreateContextAttribsARB
function EnableOpenGL(hWnd:IntPtr, hDC:IntPtr): IntPtr {
  DebugLog("Enabling OpenGL 4.6");
  ...
  DebugLog("OpenGL 4.6 context successfully created");
  Marshal.FreeHGlobal(pfd);
...
// Main entry point
function Main(): void {
  DebugLog("Main started - OpenGL 4.6 Triangle Demo");
  ...
  var hWnd = CreateWindowEx(
    0, "opengl46", WINDOW_TITLE, WS_OVERLAPPEDWINDOW | WS_VISIBLE,
  ...
  if (!LoadOpenGL3Extensions()) {
    DebugLog("Failed to load OpenGL 4.6 extensions");
  ...
  DebugLog("Main ended normally - OpenGL 4.6 Triangle Demo completed");
}
