...
CComPtr<ID2D1HwndRenderTarget> CreateRenderTarget(HWND hWnd);
void Draw(ID2D1HwndRenderTarget* renderTarget);

CComPtr<ID2D1HwndRenderTarget> g_renderTarget;
...
void Draw(ID2D1HwndRenderTarget* renderTarget)
{
    ...
    renderTarget->DrawLine(p2, p3, brush);
    renderTarget->DrawLine(p3, p1, brush);
