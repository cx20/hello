...
public class Hello
{
    ...
    private void LoadAssets()
    {
        ...
        Console.WriteLine($"  NumParameters: {rootSignatureDesc.NumParameters}");
        Console.WriteLine($"  pParameters: {rootSignatureDesc.pParameters:X}");
        Console.WriteLine($"  NumStaticSamplers: {rootSignatureDesc.NumStaticSamplers}");
        Console.WriteLine($"  pStaticSamplers: {rootSignatureDesc.pStaticSamplers:X}");
        Console.WriteLine($"  Flags: {rootSignatureDesc.Flags}");
        ...
        Console.WriteLine($"D3D12SerializeRootSignature result: {serializeResult:X}");
        ...
        Console.WriteLine($"  Blob pointer: {signature:X}");
        Console.WriteLine($"  Data pointer: {blobData:X}");
        Console.WriteLine($"  Size: {blobSize}");
        ...
        try
        {
            ...
            Console.WriteLine($"CreateRootSignature result: {result:X}");
            if (result < 0)
            {
                Console.WriteLine($"Failed to create root signature. HRESULT: {result:X}");
            }
            else
            {
                Console.WriteLine($"Successfully created root signature: {rootSignature:X}");
            }
        }
        finally
        {
        ...
        GCHandle inputElementsHandle = default;
        ...
        Console.WriteLine($"Pinned input layout pointer: {pInputElementDescs:X}");
        ...
        Console.WriteLine($"  RootSignature: {psoDesc.pRootSignature:X}");
        Console.WriteLine($"  VS ByteCode:");
        Console.WriteLine($"    Code Pointer: {psoDesc.VS.pShaderBytecode:X}");
        Console.WriteLine($"    Code Length: {psoDesc.VS.BytecodeLength}");
        Console.WriteLine($"  PS ByteCode:");
        Console.WriteLine($"    Code Pointer: {psoDesc.PS.pShaderBytecode:X}");
        Console.WriteLine($"    Code Length: {psoDesc.PS.BytecodeLength}");
        Console.WriteLine($"  BlendState:");
        Console.WriteLine($"    AlphaToCoverageEnable: {psoDesc.BlendState.AlphaToCoverageEnable}");
        Console.WriteLine($"    IndependentBlendEnable: {psoDesc.BlendState.IndependentBlendEnable}");
        Console.WriteLine($"  SampleMask: {psoDesc.SampleMask:X}");
        Console.WriteLine($"  InputLayout:");
        Console.WriteLine($"    Desc Pointer: {psoDesc.InputLayout.pInputElementDescs:X}");
        Console.WriteLine($"    NumElements: {psoDesc.InputLayout.NumElements}");
        Console.WriteLine($"  PrimitiveTopologyType: {psoDesc.PrimitiveTopologyType}");
        Console.WriteLine($"  NumRenderTargets: {psoDesc.NumRenderTargets}");
        if (psoDesc.RTVFormats != null)
        {
            for (int i = 0; i < Math.Min(8, psoDesc.RTVFormats.Length); i++)
            {
                Console.WriteLine($"  RTVFormat[{i}]: {psoDesc.RTVFormats[i]:X}");
            }
        }
        else
        {
        ...
        Console.WriteLine($"  DSVFormat: {psoDesc.DSVFormat:X}");
        Console.WriteLine($"  SampleDesc:");
        Console.WriteLine($"    Count: {psoDesc.SampleDesc.Count}");
        Console.WriteLine($"    Quality: {psoDesc.SampleDesc.Quality}");
        ...
        try
        {
            ...
            Console.WriteLine($"CreateGraphicsPipelineState result: {result:X}");
            if (result < 0)
            {
                Console.WriteLine($"Failed to create graphics pipeline state. HRESULT: {result:X}");
            }
            else
            {
                Console.WriteLine($"Successfully created pipeline state: {pipelineState:X}");
            }
        }
        catch (Exception ex)
        {
        ...
        try
        {
            ...
            Console.WriteLine($"CreateCommandList result: {result:X}");
            if (result < 0)
            {
                Console.WriteLine($"Failed to create command list. HRESULT: {result:X}");
            }
            else
            {
                Console.WriteLine($"Successfully created command list: {commandList:X}");
                ...
                try
                {
                    ...
                    Console.WriteLine($"Close result: {closeResult:X}");
                }
                catch (Exception ex)
                {
        ...
        try
        {
            ...
            Console.WriteLine($"CreateCommittedResource result: {result:X}");
            if (result < 0)
            {
                Console.WriteLine($"Failed to create committed resource. HRESULT: {result:X}");
            }
            else
            {
                Console.WriteLine($"Successfully created vertex buffer: {vertexBuffer:X}");
            }
        }
        catch (Exception ex)
        {
        ...
        Console.WriteLine($"  BufferLocation: {vertexBufferView.BufferLocation:X}");
        Console.WriteLine($"  SizeInBytes: {vertexBufferView.SizeInBytes}");
        Console.WriteLine($"  StrideInBytes: {vertexBufferView.StrideInBytes}");
        ...
        try
        {
            ...
            Console.WriteLine($"CreateFence result: {result:X}");
            if (result < 0)
            {
                Console.WriteLine($"Failed to create fence. HRESULT: {result:X}");
            }
            else
            {
                Console.WriteLine($"Successfully created fence: {fence:X}");
    ...
    private void PopulateCommandList()
    {
        ...
        try
        {
           ...
           if (resetResult < 0)
           {
               Console.WriteLine($"Failed to reset command allocator. HRESULT: {resetResult:X}");
               return;
           }
           ...
           if (result < 0)
           {
               Console.WriteLine($"Failed to reset command list. HRESULT: {result:X}");
               return;
           }
