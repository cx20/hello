...
public class HelloWindow : GameWindow
{
    ...
    protected override void OnLoad()
    {
        ...
        int posAttrib = _shader.GetAttribLocation("position");
        GL.EnableVertexAttribArray(posAttrib);
    
        int colAttrib = _shader.GetAttribLocation("color");
        ...
        GL.VertexAttribPointer(colAttrib, 3, VertexAttribPointerType.Float, false, 0, 0);
