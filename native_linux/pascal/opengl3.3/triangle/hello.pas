...
type
  ...
  { GLvoid     = void; }        PGLvoid     = Pointer;
    ...
    TglXCreateContextAttribsARB = function(display: TDisplay; config: TGLXFBConfig; share_context: TGLXContext; direct: cint; attrib_list: PGLint): TGLXContext; cdecl;
...
function  XSync(display: TDisplay; discard: cint): cint; cdecl; external libX11;
...
begin
    glXCreateContextAttribsARB := TglXCreateContextAttribsARB(glXGetProcAddressARB('glXCreateContextAttribsARB'));
    ...
    glGenVertexArrays          := TglGenVertexArrays         (glXGetProcAddressARB('glGenVertexArrays'));
    glBindVertexArray          := TglBindVertexArray         (glXGetProcAddressARB('glBindVertexArray'));
end;
...
begin
    ...
    ctxAttribs[0] := GLX_CONTEXT_MAJOR_VERSION_ARB;    ctxAttribs[1] := 3;
    ctxAttribs[2] := GLX_CONTEXT_MINOR_VERSION_ARB;    ctxAttribs[3] := 3;
    ctxAttribs[4] := GLX_CONTEXT_PROFILE_MASK_ARB;     ctxAttribs[5] := GLX_CONTEXT_CORE_PROFILE_BIT_ARB;
    ctxAttribs[6] := None_;                             ctxAttribs[7] := None_;

    context := glXCreateContextAttribsARB(display, bestFbc, nil, True_, @ctxAttribs[0]);
    XSync(display, 0);
