...
public class Hello {
    ...
    static final int D3D11_RLDO_DETAIL = 0x2;
    ...
    // Optional debug interfaces
    static Pointer g_pD3D11Debug;
    static Pointer g_pInfoQueue;

    // IID definitions
    static final byte[] IID_ID3D11Texture2D = new byte[] {
        (byte)0xf2, (byte)0xaa, (byte)0x15, (byte)0x6f,
        (byte)0x08, (byte)0xd2,
        (byte)0x89, (byte)0x4e,
        (byte)0x9a, (byte)0xb4,
        (byte)0x48, (byte)0x95, (byte)0x35, (byte)0xd3, (byte)0x4f, (byte)0x9c
    };
    ...
    static boolean createShaders() {
        ...
        layoutDesc.setInt(24, D3D11_INPUT_PER_VERTEX_DATA);
    ...
    static boolean createVertexBuffer() {
        ...
        bufferDesc.setInt(4, D3D11_USAGE_DEFAULT);
        bufferDesc.setInt(8, D3D11_BIND_VERTEX_BUFFER);
    ...
    static void initDebugInterfaces() {
        ...
        int hr = callCOM(g_pd3dDevice, 0, iidDbg, ppDbg);
        if (hr >= 0) {
