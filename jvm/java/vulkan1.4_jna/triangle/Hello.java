...
public class Hello {
    ...
    static void createWindow() {
        ...
        g_hWnd = User32.INSTANCE.CreateWindowExW(
                0,
                className,
                new WString("Vulkan 1.4 Triangle (JNA only)"),
    ...
    static void createInstance() {
        ...
        app.pNext = null;
        Memory appName = utf8z("VulkanTriangle");
    ...
    static void recordCommandBuffers() {
        ...
        ccv.float32[0] = 1.0f;  // R (white background)
        ccv.float32[1] = 1.0f;  // G
        ccv.float32[2] = 1.0f;  // B
        ccv.float32[3] = 1.0f;  // A
        ccv.write();
        ...
        for (int i = 0; i < swapchainImageCount; i++) {
            ...
            vkCmdSetViewport.invokeVoid(new Object[]{commandBuffers[i], 0, 1, vpStruct.getPointer()});
