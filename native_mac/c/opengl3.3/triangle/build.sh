...
cc -DGL_SILENCE_DEPRECATION -o hello hello.c -I"$GLFW_PREFIX/include" -L"$GLFW_PREFIX/lib" -lglfw -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo
