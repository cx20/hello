...
public class Hello implements GLEventListener {
   ...
   public void display(GLAutoDrawable drawable) {
        ...
        gl.glBufferData(GL2ES2.GL_ARRAY_BUFFER, 4 * vertices.length, vertexBuffer, GL2ES2.GL_STATIC_DRAW);

        gl.glBindBuffer(GL2ES2.GL_ARRAY_BUFFER, vbo[1]);
        gl.glBufferData(GL2ES2.GL_ARRAY_BUFFER, 4 * colors.length, vertexColorBuffer, GL2ES2.GL_STATIC_DRAW);
        ...
        gl.glBindBuffer(GL2ES2.GL_ARRAY_BUFFER, vbo[0]);
        gl.glVertexAttribPointer(posAttrib, 3, GL2ES2.GL_FLOAT, false, 0, 0);

        gl.glBindBuffer(GL2ES2.GL_ARRAY_BUFFER, vbo[1]);
        gl.glVertexAttribPointer(colAttrib, 3, GL2ES2.GL_FLOAT, false, 0, 0);
