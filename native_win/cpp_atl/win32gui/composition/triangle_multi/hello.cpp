...
// ============================================================
// Forward declarations used by the ATL window
// ============================================================
...
public:
    DECLARE_WND_CLASS_EX(_T("DCompMultiAtlClass"), CS_HREDRAW | CS_VREDRAW | CS_OWNDC, COLOR_WINDOW)
...
static void CommitComposition() {
    ...
    dbg("[Main] DComp Commit ok - entering ATL message loop\n");
}
