// hello.cpp - WinUI3 XAML Island Triangle Sample using ATL
//
// Draws a gradient-filled triangle via WinUI3 XAML DesktopWindowXamlSource
// hosted inside an ATL CWindowImpl window. No WTL or MFC dependency.
...
//---------------------------------------------------------------------
// CMainWindow - ATL CWindowImpl hosting the XAML island
//---------------------------------------------------------------------
class CMainWindow : public CWindowImpl<CMainWindow>
{
public:
    DECLARE_WND_CLASS(_T("MainWindowClass"))
...
LRESULT CMainWindow::OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
{
    ...
    if (hHost == nullptr)
    {
        LogState("CMainWindow::OnCreate", "host window create failed");
        return -1;
    }
...
{
    LogState("CMainWindow::OnDestroy", "begin");
    if (m_xamlSource)
    {
    ...
    ::PostQuitMessage(0);
    LogState("CMainWindow::OnDestroy", "end");
    return 0;
}

UIElement CMainWindow::CreateTriangleContent()
{
    Canvas canvas;
...
bool CMainWindow::InitializeXamlIsland()
{
    ...
    {
        LogState("CMainWindow::InitializeXamlIsland", "hresult_error=0x%08X", static_cast<unsigned>(e.code()));
        return false;
    }
    catch (...)
    {
        LogState("CMainWindow::InitializeXamlIsland", "unknown exception");
        return false;
    }
...
int WINAPI _tWinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPTSTR /*lpCmdLine*/, int nCmdShow)
{
    ...
    CMainWindow wndMain;
    RECT rcWnd = { 0, 0, 960, 540 };
    ::AdjustWindowRectEx(&rcWnd, WS_OVERLAPPEDWINDOW, FALSE, 0);
    wndMain.Create(
        nullptr,
        rcWnd,
        _T("Hello, World!"),
