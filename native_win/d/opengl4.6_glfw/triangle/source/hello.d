...
{
    char[256] buf = void;
    const int n = snprintf(buf.ptr, buf.length, "[opengl4.6_glfw/d] %s=%d\n", label, value);
    if (n > 0) {
...
// Shader sources
immutable string vertexSource = `#version 460 core
...
immutable string fragmentSource = `#version 460 core
...
int WinMain(HINSTANCE /* hInstance */, HINSTANCE /* hPrevInstance */, LPSTR /* lpCmdLine */, int /* nCmdShow */)
{
    ...
    if (ret != glfwSupport) {
        debugLog("[opengl4.6_glfw/d] loadGLFW default failed, trying explicit DLL path\n");
        ...
        if (ret != glfwSupport) {
            debugLog("[opengl4.6_glfw/d] loadGLFW failed\n");
            return 1;
        }
    }
    debugLog("[opengl4.6_glfw/d] loadGLFW ok\n");
