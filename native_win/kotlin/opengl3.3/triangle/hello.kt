...
private const val WINDOW_NAME = "Hello OpenGL 3.3 (Kotlin/Native)"
...
// WGL ARB constants for OpenGL 3.3 Core Profile context creation
...
private fun enableOpenGL(hdc: HDC?): HGLRC? = memScoped {
    debugPrint("[enableOpenGL] Starting OpenGL 3.3 context creation...")
    ...
    // Create a temporary legacy context to load wglCreateContextAttribsARB
    ...
    if (hrc == null) {
        debugPrint("[enableOpenGL] ERROR: wglCreateContextAttribsARB failed")
        debugPrint("[enableOpenGL] Falling back to legacy context")
        return@memScoped hrcOld
    }
    debugPrint("[enableOpenGL] OpenGL 3.3 Core Profile context created")

    // Switch to the new context and delete the old one
    wglMakeCurrent(hdc, hrc)
    wglDeleteContext(hrcOld)
    debugPrint("[enableOpenGL] OpenGL 3.3 context is now active")
...
private fun initShaderAndBuffers() = memScoped {
    ...
    // Create and bind VAO (required for OpenGL 3.3 Core Profile)
...
fun main() {
    initDebugOutput()
    debugPrint("[main] ========== Starting Kotlin/Native OpenGL 3.3 Triangle Sample ==========")
    ...
    memScoped {
        ...
        debugPrint("[main] Enabling OpenGL 3.3...")
        ...
        debugPrint("[main] OpenGL 3.3 enabled successfully")
