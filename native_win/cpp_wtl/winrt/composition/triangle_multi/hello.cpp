...
// ============================================================
// Win32 / ATL / WTL headers  (must precede WinRT headers)
// ============================================================
...
public:
    DECLARE_WND_CLASS_EX(_T("WucMultiWtlClass"), CS_HREDRAW | CS_VREDRAW | CS_OWNDC, COLOR_WINDOW)
...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE, LPTSTR, int nCmdShow) {
    ...
    try {
        ...
        dbg("[Main] WUC visual tree ready - entering WTL message loop\n");
