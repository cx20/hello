...
public class VulkanTriangle : Form
{
    #region Constants
    ...
    const uint VK_CULL_MODE_BACK_BIT = 0x00000002;
    const uint VK_FRONT_FACE_CLOCKWISE = 1;
    ...
    static extern int vkCreateInstance(ref VkInstanceCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pInstance);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyInstance(IntPtr instance, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkEnumeratePhysicalDevices(IntPtr instance, ref uint pPhysicalDeviceCount, IntPtr[] pPhysicalDevices);
    ...
    [DllImport("vulkan-1.dll")]
    static extern int vkCreateDevice(IntPtr physicalDevice, ref VkDeviceCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pDevice);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyDevice(IntPtr device, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern void vkGetDeviceQueue(IntPtr device, uint queueFamilyIndex, uint queueIndex, out IntPtr pQueue);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateWin32SurfaceKHR(IntPtr instance, ref VkWin32SurfaceCreateInfoKHR pCreateInfo, IntPtr pAllocator, out IntPtr pSurface);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroySurfaceKHR(IntPtr instance, IntPtr surface, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkGetPhysicalDeviceSurfaceSupportKHR(IntPtr physicalDevice, uint queueFamilyIndex, IntPtr surface, out uint pSupported);

    [DllImport("vulkan-1.dll")]
    static extern int vkGetPhysicalDeviceSurfaceCapabilitiesKHR(IntPtr physicalDevice, IntPtr surface, out VkSurfaceCapabilitiesKHR pSurfaceCapabilities);

    [DllImport("vulkan-1.dll")]
    static extern int vkGetPhysicalDeviceSurfaceFormatsKHR(IntPtr physicalDevice, IntPtr surface, ref uint pSurfaceFormatCount, IntPtr pSurfaceFormats);

    [DllImport("vulkan-1.dll")]
    static extern int vkGetPhysicalDeviceSurfacePresentModesKHR(IntPtr physicalDevice, IntPtr surface, ref uint pPresentModeCount, IntPtr pPresentModes);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateSwapchainKHR(IntPtr device, ref VkSwapchainCreateInfoKHR pCreateInfo, IntPtr pAllocator, out IntPtr pSwapchain);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroySwapchainKHR(IntPtr device, IntPtr swapchain, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkGetSwapchainImagesKHR(IntPtr device, IntPtr swapchain, ref uint pSwapchainImageCount, IntPtr[] pSwapchainImages);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateImageView(IntPtr device, ref VkImageViewCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pView);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyImageView(IntPtr device, IntPtr imageView, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateShaderModule(IntPtr device, ref VkShaderModuleCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pShaderModule);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyShaderModule(IntPtr device, IntPtr shaderModule, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreatePipelineLayout(IntPtr device, ref VkPipelineLayoutCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pPipelineLayout);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyPipelineLayout(IntPtr device, IntPtr pipelineLayout, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateRenderPass(IntPtr device, ref VkRenderPassCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pRenderPass);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyRenderPass(IntPtr device, IntPtr renderPass, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateGraphicsPipelines(IntPtr device, IntPtr pipelineCache, uint createInfoCount, ref VkGraphicsPipelineCreateInfo pCreateInfos, IntPtr pAllocator, out IntPtr pPipelines);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyPipeline(IntPtr device, IntPtr pipeline, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateFramebuffer(IntPtr device, ref VkFramebufferCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pFramebuffer);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyFramebuffer(IntPtr device, IntPtr framebuffer, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateCommandPool(IntPtr device, ref VkCommandPoolCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pCommandPool);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyCommandPool(IntPtr device, IntPtr commandPool, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkAllocateCommandBuffers(IntPtr device, ref VkCommandBufferAllocateInfo pAllocateInfo, IntPtr[] pCommandBuffers);

    [DllImport("vulkan-1.dll")]
    static extern int vkBeginCommandBuffer(IntPtr commandBuffer, ref VkCommandBufferBeginInfo pBeginInfo);

    [DllImport("vulkan-1.dll")]
    static extern int vkEndCommandBuffer(IntPtr commandBuffer);

    [DllImport("vulkan-1.dll")]
    static extern void vkCmdBeginRenderPass(IntPtr commandBuffer, ref VkRenderPassBeginInfo pRenderPassBegin, uint contents);
    ...
    [DllImport("vulkan-1.dll")]
    static extern void vkCmdSetViewport(IntPtr commandBuffer, uint firstViewport, uint viewportCount, ref VkViewport pViewports);

    [DllImport("vulkan-1.dll")]
    static extern void vkCmdSetScissor(IntPtr commandBuffer, uint firstScissor, uint scissorCount, ref VkRect2D pScissors);
    ...
    [DllImport("vulkan-1.dll")]
    static extern int vkCreateSemaphore(IntPtr device, ref VkSemaphoreCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pSemaphore);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroySemaphore(IntPtr device, IntPtr semaphore, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkCreateFence(IntPtr device, ref VkFenceCreateInfo pCreateInfo, IntPtr pAllocator, out IntPtr pFence);

    [DllImport("vulkan-1.dll")]
    static extern void vkDestroyFence(IntPtr device, IntPtr fence, IntPtr pAllocator);

    [DllImport("vulkan-1.dll")]
    static extern int vkWaitForFences(IntPtr device, uint fenceCount, IntPtr[] pFences, uint waitAll, ulong timeout);

    [DllImport("vulkan-1.dll")]
    static extern int vkResetFences(IntPtr device, uint fenceCount, IntPtr[] pFences);

    [DllImport("vulkan-1.dll")]
    static extern int vkAcquireNextImageKHR(IntPtr device, IntPtr swapchain, ulong timeout, IntPtr semaphore, IntPtr fence, out uint pImageIndex);

    [DllImport("vulkan-1.dll")]
    static extern int vkQueueSubmit(IntPtr queue, uint submitCount, ref VkSubmitInfo pSubmits, IntPtr fence);

    [DllImport("vulkan-1.dll")]
    static extern int vkQueuePresentKHR(IntPtr queue, ref VkPresentInfoKHR pPresentInfo);
    ...
    public VulkanTriangle(string vertPath, string fragPath)
    {
        vertexShaderPath = vertPath;
        fragmentShaderPath = fragPath;
        
        this.Size = new Size(800, 600);
        this.Text = "Vulkan Triangle (PowerShell)";
    ...
    protected override void OnHandleCreated(EventArgs e)
    {
        ...
        renderTimer.Interval = 16; // 約60fps
        renderTimer.Tick += (s, ev) => { DrawFrame(); };
        renderTimer.Start();
    }
    ...
    void CreateInstance()
    {
        IntPtr appNamePtr = Marshal.StringToHGlobalAnsi("Vulkan Triangle");
        ...
        IntPtr appInfoPtr = Marshal.AllocHGlobal(Marshal.SizeOf(appInfo));
    ...
    void FindQueueFamilies()
    {
        ...
        int size = Marshal.SizeOf<VkQueueFamilyProperties>();
        IntPtr buffer = Marshal.AllocHGlobal(size * (int)queueFamilyCount);
        vkGetPhysicalDeviceQueueFamilyProperties(physicalDevice, ref queueFamilyCount, buffer);
        ...
        {
            VkQueueFamilyProperties props = Marshal.PtrToStructure<VkQueueFamilyProperties>(buffer + (int)i * size);

            if ((props.queueFlags & VK_QUEUE_GRAPHICS_BIT) != 0 && !foundGraphics)
            {
            ...
            uint supported;
            vkGetPhysicalDeviceSurfaceSupportKHR(physicalDevice, i, surface, out supported);
            if (supported == VK_TRUE && !foundPresent)
            {
    ...
    void CreateLogicalDevice()
    {
        ...
        GCHandle priorityHandle = GCHandle.Alloc(queuePriority, GCHandleType.Pinned);
    ...
    public static void Main(string[] args)
    {
        if (args.Length < 2)
        {
            Console.WriteLine("Usage: VulkanTriangle <vertex_shader.vert> <fragment_shader.frag>");
            return;
        }

        Application.EnableVisualStyles();
        Application.SetCompatibleTextRenderingDefault(false);
        Application.Run(new VulkanTriangle(args[0], args[1]));
    }
}
'@
...
Write-Host "Vulkan Triangle Sample (PowerShell)"
Write-Host "====================================="
...
try {
    ...
    $form = New-Object VulkanTriangle($vertShaderPath, $fragShaderPath)
