...
unsafe public class Hello
{
    ...
    const uint GRADIENT_FILL_TRIANGLE = 0x00000002;
    ...
    static extern int GradientFill(IntPtr hdc, TRIVERTEX[] pVertex, uint nVertex, void* pMesh, uint nMesh, uint ulMode);
    ...
    static void OnPaint(IntPtr hdc)
    {
        DrawTriangle(hdc);
    }


    static void DrawTriangle(IntPtr hdc)
    {
        int WIDTH  = 640;
        int HEIGHT = 480;
