...
' Harmonograph animation parameters (updated each frame like C# version)
...
Private Function CreatePipelineStates() As Boolean
    ...
    graphicsPsoDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_LINE  ' LINE for LINESTRIP
...
' ============================================================
' Floating point modulo (VBA Mod only works with integers)
' ============================================================
