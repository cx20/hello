...
# Draw triangle using OpenGL 1.0 immediate mode
def draw_triangle
...
class_name = "RubyOpenGL10"

wc = User32::WNDCLASSEX.malloc
wc.cbSize        = User32::WNDCLASSEX.size
wc.style         = User32::CS_OWNDC  # Important for OpenGL
