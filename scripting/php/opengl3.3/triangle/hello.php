...
/*
  Win32 + OpenGL 3.3 from PHP via FFI
  
  Draws a colored triangle using OpenGL 3.3 Core Profile with:
  - Vertex Array Objects (VAO)
  - Vertex Buffer Objects (VBO)
  - GLSL 330 Core Shaders (Vertex & Fragment)
...
// FFI for OpenGL 3.3 function pointer types
$glext = FFI::cdef('
    typedef void* HDC;
    typedef void* HGLRC;
    typedef unsigned int GLenum;
    ...
    // Function pointer types for OpenGL 3.3
...
$className  = wbuf("PHPOpenGL33Window");
...
function enableOpenGL($gdi32, $opengl32, $glext, $hDC)
{
    ...
    echo "OpenGL 3.3 Core Profile context created\n";
    return $hRC;
}
...
echo "OpenGL 3.3 context created\n";

// Get OpenGL 3.3 extension functions
...
echo "OpenGL 3.3 functions loaded\n";
...
echo "OpenGL 3.3 initialized successfully\n";
