...
/*
  Win32 + OpenGL 1.1 from PHP via FFI
  
  Draws a colored triangle using OpenGL 1.1 Vertex Arrays
  (glEnableClientState, glColorPointer, glVertexPointer, glDrawArrays).
*/
...
// opengl32.dll - OpenGL 1.1 with Vertex Arrays
$opengl32 = FFI::cdef('
    typedef void* HDC;
    typedef void* HGLRC;
    typedef int BOOL;
...
$className  = wbuf("PHPOpenGL11Window");
...
function drawTriangle($opengl32): void
{
    ...
    // Color array (RGB for 3 vertices)
    ...
    // Vertex array (XY for 3 vertices)
    $vertices = FFI::new('float[6]');
    // Vertex 0 - Top
    ...
    // Set pointers
    $opengl32->glColorPointer(3, GL_FLOAT, 0, FFI::addr($colors[0]));
    $opengl32->glVertexPointer(2, GL_FLOAT, 0, FFI::addr($vertices[0]));
...
echo "OpenGL 1.1 initialized successfully\n";
