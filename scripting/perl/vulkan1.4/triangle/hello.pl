#!/usr/bin/perl
# -*- coding: utf-8 -*-
# Vulkan 1.4 Triangle (Windows, Perl, FFI::Platypus + Win32::API)
#
...
print "=== Perl Vulkan 1.4 Triangle ===\n\n";
...
sub create_window {
    ...
    my $className = encode_utf16("PerlVulkanTriangle");
...
sub create_vk_instance {
    ...
    my $app_name = "PerlVulkanTriangle\0";
...
sub create_swapchain_bundle {
    ...
    record_command_buffers($device, \%b);
...
eval {
    ...
    my ($hwnd, $hinst) = create_window("Vulkan 1.4 Triangle (Perl + shaderc)", 800, 600);
