...
void CMainFrame::EnableOpenGL()
{
    ...
    HGLRC hGLRC_old = wglCreateContext(m_pDC->m_hDC);
    wglMakeCurrent(m_pDC->m_hDC, hGLRC_old);

    wglCreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC)wglGetProcAddress("wglCreateContextAttribsARB");

/*
    static const int  opengl_gl33[]= {
...
*/
    ...
    //m_hRC = wglCreateContextAttribsARB(m_pDC->m_hDC, 0, opengl_gl33);
    m_hRC = wglCreateContextAttribsARB(m_pDC->m_hDC, 0, NULL);
